    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0F172A]/85 backdrop-blur-md shadow-[0_10px_30px_rgba(15,23,42,0.5)]">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <nav className="flex items-center gap-1 text-sm font-medium">
          <Link to="movies-in-billboard" className="rounded-lg bg-[#7C3AED]/15 px-3 py-1.5 text-[#818CF8] transition-colors hover:bg-[#7C3AED]/20">
            Cartelera
          </Link>
          <Link to="upcomming-movies" className="rounded-lg px-3 py-1.5 text-slate-300 transition-colors hover:bg-white/5 hover:text-white">
            Próximamente
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="rounded-xl bg-[#7C3AED] px-4 py-1.5 text-sm font-semibold text-white transition-all hover:opacity-90">
            Ingresar
          </button>
        </div>
      </div>
